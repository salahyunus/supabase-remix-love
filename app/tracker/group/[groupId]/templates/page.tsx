...
import { TemplateSprintList } from "../_components/sprint-list-templates";
import { TemplateInfo } from "../_components/TemplateInfo";
import Temlist from "../_components/temlist";
...
const GroupIdPage = async () => {
  ...
  return (
    <div className="w-full mb-20 pr-4">
      ...
      <TemplateInfo
        num={sprintCount}
        name={sprintCount === 1 ? "sprint" : "sprints"}
      />
      <Separator className="my-4" />
      <div className="px-2 md:px-4">
        <Suspense fallback={<TemplateSprintList.Skeleton />}>
          <Temlist />
        </Suspense>
      </div>
    </div>
