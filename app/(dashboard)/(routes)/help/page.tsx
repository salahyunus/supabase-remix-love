...
const TutorPage = () => {
  ...
  const handleCopy = () => {
    if (typeof window !== "undefined" && navigator.clipboard) {
      const text = "user.quackly@gmail.com";
              ...
              <div className="flex justify-center flex-wrap gap-10 mb-12">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    <AccordionTrigger>What is Quackly?</AccordionTrigger>
                    <AccordionContent>
                      Quackly is a free all-in-one platform for learning web
                      development, offering expert-led courses, website
                      builders, flashcards, planners, timers, and powerful
                      productivity tools. Our mission is to make web development
                      accessible to everyone, showing that it&apos;s the easiest
                      entry point to coding—and a gateway to mastering any
                      programming language. All tools and resources are provided
                      at no cost, helping learners stay organized, motivated,
                      and on track toward becoming confident developers.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    <AccordionTrigger>
                      {" "}
                      Is Quackly really free?
                    </AccordionTrigger>
                    <AccordionContent>
                      YES, Quackly is entirely free! All the tools, courses,
                      flashcards, planners, and video tutorials are available at
                      no cost. We believe that learning web development should
                  ...
                  <AccordionItem value="item-3">
                    <AccordionTrigger>
                      {" "}
                      Which skills are covered on Quackly?
                    </AccordionTrigger>
                    <AccordionContent>
                      Quackly covers a wide range of web development and
                      tech-related skills. You&apos;ll start with the basics
                      like HTML, CSS, and JavaScript, and move on to advanced
                      topics such as React.js, Next.js, and TypeScript. We also
                      cover essential tools and practices like Git, GitHub,
                      proper laptop usage, coding best practices, and
                      market-ready development workflows. Our goal is to equip
                      you with both foundational and industry-relevant skills.
                    </AccordionContent>
                  </AccordionItem>{" "}
                  <AccordionItem value="item-3">
                    <AccordionTrigger>
                      {" "}
                      Can I contribute to Quackly?
                    </AccordionTrigger>
                    <AccordionContent>
                      Yes! If you have valuable content like tutorials, tips,
                      tools, or resources related to web development and coding,
                      you can contribute to Quackly. Just reach out through our
                      “apply as a creator” page to get involved. We welcome all
                      contributions that help make coding more accessible and
                      fun!
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
