      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grod-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-4">
        ...
        {items.map((item) => (
          <NoteCard
            ...
            imageUrl={
              item.imageUrl ??
              "https://public.blenderkit.com/thumbnails/assets/9c901c2bd5c9494abd40794d52f44c19/files/thumbnail_074e9e83-4d19-4887-8816-ddb53d1ad3bb.png.2048x2048_q85.png"
            }
