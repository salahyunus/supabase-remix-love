    ...
    <div className="pb-20 pt-32 relative">
      ...
      <div className="flex justify-center relative  z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            words="Build and Learn Faster with Quackly — Your All-in-One Dev Platform"
            className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80"
          />

          <TextGenerateEffect
            className="text-center md:tracking-wider mb-0 text-sm md:text-lg lg:text-xl"
            words="Learn to code, build stunning websites, and access powerful tools — all in one place, built for developers."
          />
