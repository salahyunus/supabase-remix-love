...
const testimonials = [
  ...
  {
    quote:
      "Join or create communities of successful students, study together and ace your exams!",
    name: "StudyHubs",
    designation: "Let's do it together!",
    src: "/studyhubs.png",
    link: "/studyhub",
  },
  {
    ...
    <section id="typer">
      <div className="w-full py-20">
        <div className="text-4xl mx-auto font-medium text-neutral-600 text-center">
          ...
          />
          <br />
          with <span className="text-purple-gradient">Quackly.</span>
        </div>
      </div>
      <div className="mb-6">
